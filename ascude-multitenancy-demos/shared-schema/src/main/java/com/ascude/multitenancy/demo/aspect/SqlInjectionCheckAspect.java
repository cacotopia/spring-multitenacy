package com.ascude.multitenancy.demo.aspect;

import com.ascude.multitenancy.demo.exception.MyException;
...
public class SqlInjectionCheckAspect {
    ...
    @Pointcut("@within(com.ascude.multitenancy.demo.annotation.SqlInjectionCheck) || @annotation(com.ascude.multitenancy.demo.annotation.SqlInjectionCheck)")
