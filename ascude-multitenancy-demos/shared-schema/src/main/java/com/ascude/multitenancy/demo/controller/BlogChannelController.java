package com.ascude.multitenancy.demo.controller;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.ascude.multitenancy.demo.base.BaseController;
...
import com.ascude.multitenancy.demo.util.RestResponse;

import jakarta.servlet.http.HttpServletRequest;

import com.ascude.multitenancy.demo.annotation.SysLog;
...
public class BlogChannelController extends BaseController {
    ...
    public BlogChannelController(BlogChannelService blogChannelService, BlogArticleService blogArticleService) {
